...
const mony_box = document.createElement('div')
const button = document.createElement('button')

for (let i = 0; i < 3; i++) {
    let round = document.createElement("div")
    round.classList.add('round')
    mony_box.append(round)
}

container.classList.add('container')
img_box.classList.add('img_box')
pictures.classList.add('img')
img.classList.add('bag')
text_box.classList.add('text_box')
mony_box.classList.add('mony_box')
...
img_box.append(pictures, text_box,)
pictures.append(img)
text_box.append(h2,p,button)
